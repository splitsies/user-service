...
import { IFirebaseProvider, ILogger } from "@splitsies/utils";
...
export class AuthInteractor implements IAuthInteractor {
    constructor(
        ...
        @inject(IFirebaseProvider) private readonly firebaseProvider: IFirebaseProvider,
    ...
    delete(userId: string): Promise<void> {
        const auth = this.firebaseProvider.provideAdminAuth();
